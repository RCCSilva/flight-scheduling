...
export function composeResults<Arg1>(
  func1: () => Promise<Result<Arg1>> | Result<Arg1>
): () => Promise<Result<Arg1>>

export function composeResults<Arg1, Arg2>(
  func1: () => Promise<Result<Arg1>> | Result<Arg1>,
...
export function composeResults<Arg1, Arg2, Arg3>(
  func1: () => Promise<Result<Arg1>> | Result<Arg1>,
  func2: (input: Arg1) => Promise<Result<Arg2>> | Result<Arg2>,
...
export function composeResults<Arg1, Arg2, Arg3, Arg4>(
  func1: () => Promise<Arg1> | Arg1,
  func2: (input: Arg1) => Promise<Result<Arg2>> | Result<Arg2>,
  func3: (input: Arg2) => Promise<Result<Arg3>> | Result<Arg3>,
  func4: (infer: Arg3) => Promise<Result<Arg4>> | Result<Arg4>
): () => Promise<Result<Arg4>>
